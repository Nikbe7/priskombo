      ...
      <div className="max-w-6xl mx-auto">
        ...
        {uniqueDeals.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Vi använder nu uniqueDeals istället för deals */}
            {uniqueDeals.map((p) => (
              <div
                key={p.id}
                className="relative bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition group"
              >
                {/* Rabatt-etikett */}
