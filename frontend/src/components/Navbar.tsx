...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 bg-slate-900 border-b border-slate-800 shadow-xl transition-all duration-300">
      ...
      <div className="md:hidden px-4 pb-3 pt-0 bg-slate-900">
         <Suspense>
